...
vendas_zoop_dyf = glueContext.create_dynamic_frame.from_catalog(database='NOME_DATABASE', table_name='NOME_TABELA_BRONZE')
...
# Importando funções sql do Spark para passar nomes das colunas, concatenar valores e formatar data  
...
s3output = glueContext.getSink(
  path="s3://NOME_BUCKET/silver/NOME_PASTA_SEPARADA/",
  connection_type="s3",
